...
namespace DWQueueAPI
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            // کانفیگ کش توزیع‌شده ردیس
            builder.Services.AddStackExchangeRedisCache(options =>
            {
                // "dwqueue-redis" نام همان کانتینری است که در داکر کامپوز تعریف کردیم
                options.Configuration = "dwqueue-redis:6379";
                options.InstanceName = "DWQueue_"; // پیشوندی برای کلیدهای ما در ردیس
            });
